...
format_ref(mc)
#> [1] "DeBruine L, Lakens D, Werner J (2026). <em>metacheck: Check Research Outputs for Best Practices</em>. R package version 0.1.0, <a href=\"https://github.com/scienceverse/metacheck\">https://github.com/scienceverse/metacheck</a>."
