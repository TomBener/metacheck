...
See [Get
Started](https://scienceverse.github.io/metacheck/dev/articles/metacheck.md)
for the basics,
[Articles](https://scienceverse.github.io/metacheck/dev/articles/) for
more detailed examples of what you can do, or our [introductory blog
post](https://scienceverse.github.io/metacheck/dev/articles/intro.md)
for a more conceptual overview.
