...
- Much less buggy
  [`.grobid_to_bibr()`](https://scienceverse.github.io/metacheck/dev/reference/dot-grobid_to_bibr.md)
...
- Improvements to
  [`.tei_text()`](https://scienceverse.github.io/metacheck/dev/reference/dot-tei_text.md)
...
- Module helpers:
  ...
  [`pb()`](https://scienceverse.github.io/metacheck/dev/reference/pb.md)
