...
Framework](https://scienceverse.github.io/metacheck/dev/articles/www.osf.io).
...
[`osf_retrieve()`](https://scienceverse.github.io/metacheck/dev/reference/osf_retrieve.md)
function.
...
#>  [9] ggplot2_4.0.1     tidyverse_2.0.0   metacheck_0.0.1.0
#> 
...
#> [13] jsonlite_2.0.0     progress_1.2.3     svutils_0.0.0.9002 scales_1.4.0      
#> [17] httr2_1.2.2        textshaping_1.0.4  jquerylib_0.1.4    cli_3.6.5         
#> [21] crayon_1.5.3       rlang_1.1.7        oddpub_7.2.3       withr_3.0.2       
#> [25] cachem_1.1.0       yaml_2.3.12        otel_0.2.0         tools_4.5.2       
#> [29] tzdb_0.5.0         DT_0.34.0          curl_7.0.0         vctrs_0.7.2       
#> [33] R6_2.6.1           lifecycle_1.0.5    fs_1.6.6           htmlwidgets_1.6.4 
#> [37] ragg_1.5.0         pkgconfig_2.0.3    desc_1.4.3         pkgdown_2.2.0     
#> [41] bslib_0.9.0        pillar_1.11.1      gtable_0.3.6       glue_1.8.0        
#> [45] systemfonts_1.3.1  xfun_0.56          tidyselect_1.2.1   rstudioapi_0.18.0 
#> [49] knitr_1.51         farver_2.1.2       htmltools_0.5.9    rmarkdown_2.30    
#> [53] compiler_4.5.2     prettyunits_1.2.0  S7_0.2.1
```
...
**These examples were created using papercheck version 0.0.1.0.**
