...
- ⚪️ [Replication Check](#replication-check){.na}: No citations to articles in the FLoRA database were found.  
...
NA, NA), retractionwatch = c(NA, "Retraction", NA, NA)), class = "data.frame", row.names = c(NA, 
-4L))
