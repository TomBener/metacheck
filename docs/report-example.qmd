...
"<a href='https://osf.io/download/uq347/' target='_blank'>bad.Rmd</a>", 
"<a href='https://researchbox.org/4377' target='_blank'>Code/Study 1.r</a>"
), "% Comments" = c("17%", "7%", "26%", "17%"), "Missing Files" = c(1L, 
0L, 0L, 1L), "Absolute Paths" = c(1L, 1L, 2L, 1L), "Code Between Libraries" = c(NA, 
...
The scripts load files, but 2 scripts loaded 2 files that could not be automatically identified in the repository. Check if the following files are made available, so that others can reproduce your code, or that the files are missing:

```{r}
#| echo: false

# table data --------------------------------------
table <- structure(list("File name" = c("test_script.R", "Code/Study 1.r"
), "Missing Files" = c("file.csv", "file.csv")), row.names = c(1L, 
4L), class = "data.frame")
...
"Code/Study 1.r"), "Absolute paths found" = c("abs_path_pc <- read.csv(\"C:/lisa/file.csv\")", 
...
"abs_path_pc <- read.csv(\"C:/lisa/file.csv\")")), row.names = c(NA, 
4L), class = "data.frame")
