...
You will need to make sure that your module works with both single paper object sand lists of paper objects. The metacheck functions `text_search()` and `llm()` are already vectorised for paper lists. 
