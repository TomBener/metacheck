---
title: "Running the metacheck power module with Ollama (local AI)"
output:
  html_document:
    toc: true
    toc_float: true
...
3. Open the downloaded `.zip` file and move Ollama to your Applications folder
4. Open Ollama from Applications — it will appear in your menu bar
...
> - `ollama pull qwen2.5:7b` — about 4.7 GB, noticeably more capable
> - `ollama pull llama3.1` — about 4.7 GB, good general-purpose alternative
...
- On Mac, click the Ollama icon in the menu bar
...
**Switching back to cloud (Groq)**

```{r switch-to-groq, eval=FALSE}
llm_model("groq")   # or another Groq model name
```
