...
![Plot of average percentage of t-tests missing effect sizes from 2014 to 2024, showing a downward trend from 60% to around 20%](effect-size-plot.png){fig-alt="Plot of average percentage of t-test that are missing effect sizes. The x-axis shows years form 2014 to 2024 and the y-axis shows Average % missing. Theree is a fairly stead downward trend from 60% in 2014 to around 20% by 2021."}
